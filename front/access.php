...
?>
    ...
    <main>
        <div class="salon_stylist_body">
            <div class="salon">
                <h2>アクセス</h2>
                <div class="accessTopImg"><img src="../images_red/20231025_155414.jpg" alt=""></div>
                <h3><div>美容室RED</div></h3>
                <table class="access_table">
                    <tr>
                        <th>所在地</th>
                        <td>〒680-0845鳥取市富安１丁目２１３西尾ビル1F<br>（扇町ドコモさんの道を挟んで横です）</td>
                    </tr>
                    <tr>
                        <th>お問い合せ</th>
                        <td>0857-20-2221</td>
